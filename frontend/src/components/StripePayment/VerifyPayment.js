...
const VerifyPayment = () => {
	...
	const { isLoading, isError, isSuccess, isPending, data } = useQuery({
		...
		<div className="max-w-lg mx-auto my-10 p-6 bg-white shadow-md rounded-lg">
			{isLoading ? (
				...
				<div className="text-center text-green-500">
					...
					<Link to="/generate-content" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
						Start Using SolveAI
					</Link>
				</div>
			)}
