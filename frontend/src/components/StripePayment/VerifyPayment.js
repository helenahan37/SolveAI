...
const VerifyPayment = () => {
	...
	console.log(data);
	return (
		<div className="flex bg-gray-900 flex-col justify-center items-center min-h-screen">
			<div className="max-w-lg mx-h-lg mx-auto my-10 p-6 bg-white shadow-md rounded-lg">
				{isLoading ? (
